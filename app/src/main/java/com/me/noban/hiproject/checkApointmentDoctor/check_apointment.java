...
import com.me.noban.hiproject.model.apoint_model;
import com.firebase.ui.database.FirebaseRecyclerAdapter;
import com.google.firebase.auth.FirebaseAuth;
import com.google.firebase.database.DatabaseReference;
import com.google.firebase.database.FirebaseDatabase;
import com.google.firebase.database.Query;import com.me.noban.hiproject.model.apoint_model;
...
public class check_apointment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.me.noban.hiproject.R.layout.activity_check_apointment);
         uid = FirebaseAuth.getInstance().getCurrentUser().getUid();
        database= FirebaseDatabase.getInstance();
        Mypost_reference =database.getReference("data").child("0").child("Apoint");
        Mypost =findViewById(com.me.noban.hiproject.R.id.check_apointmet_doc_recykler);
    ...
    public void loadsearchMypost() {
         ...
         adapter =new FirebaseRecyclerAdapter<apoint_model, checkAppointMentViewHolder>(apoint_model.class,com.me.noban.hiproject.R.layout.check_appointment_card,checkAppointMentViewHolder.class,Mypost_reference.orderByChild("doctorId").equalTo(uid)) {
      @Override
