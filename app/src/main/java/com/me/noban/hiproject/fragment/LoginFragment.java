...
import com.me.noban.hiproject.DoctorHomeActivity;
import com.me.noban.hiproject.MainUIActivity;
import com.me.noban.hiproject.R;
import com.me.noban.hiproject.utilities.StringUtils;
import com.google.android.gms.tasks.OnCompleteListener;
import com.google.android.gms.tasks.Task;
import com.google.firebase.auth.AuthResult;
import com.google.firebase.auth.FirebaseAuth;
import com.google.firebase.auth.FirebaseAuthInvalidCredentialsException;
import com.google.firebase.auth.FirebaseAuthInvalidUserException;import com.me.noban.hiproject.DoctorHomeActivity;import com.me.noban.hiproject.MainUIActivity;import com.me.noban.hiproject.utilities.StringUtils;
...
public class LoginFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(com.me.noban.hiproject.R.layout.fragment_login_main, container, false);
        initView(view);
        return view;
    }

    private void initView(View view) {
        mUserEditText = view.findViewById(com.me.noban.hiproject.R.id.fragment_login_in_user_mail_edit_text);
        mPasswordEditText = view.findViewById(com.me.noban.hiproject.R.id.fragment_login_in_password_edit_text);
        mLoginButton = view.findViewById(com.me.noban.hiproject.R.id.fragment_login_button);
        mUserTypeRadioGroup = view.findViewById(com.me.noban.hiproject.R.id.fragment_user_type);
    ...
    private void goToDashBoardActivity() {
        ...
        switch (selectedUserType) {
            ...
            case com.me.noban.hiproject.R.id.doctor_radio_button :
                goToDoctorDashboardActivity();
                break;

            case com.me.noban.hiproject.R.id.patient_radio_button :
